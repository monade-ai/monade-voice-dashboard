...
import { PaperCard, PaperCardContent, PaperCardDescription, PaperCardFooter, PaperCardHeader, PaperCardTitle } from '@/components/ui/paper-card';

// ... existing imports ...

// Inside the return statement, in the Cards section:
             ...
             <div className="space-y-6">
                ...
                <PaperCard className="max-w-sm">
                    <PaperCardHeader>
                        ...
                        <PaperCardDescription>Living "Digital Paper" Shader.</PaperCardDescription>
                    </PaperCardHeader>
                    <PaperCardContent>
