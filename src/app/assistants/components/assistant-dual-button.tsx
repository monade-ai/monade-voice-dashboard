// components/assistant-dual-button.tsx
'use client';
...
import { usePhoneAssistant } from '@/app/hooks/use-phone-assistant';
...
export default function AssistantDualButton({ assistant }: AssistantDualButtonProps) {
